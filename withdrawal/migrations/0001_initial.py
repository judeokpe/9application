    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_type', models.CharField(choices=[('BTC', 'Bitcoin'), ('LTC', 'Litecoin'), ('USDT', 'Tether'), ('BNB', 'Binance'), ('ETH', 'Ethereum'), ('LOCAL_BANK', 'Local Bank')], max_length=10)),
                ('wallet_address', models.CharField(blank=True, max_length=100, null=True)),
                ('naira_amount', models.DecimalField(decimal_places=5, max_digits=20)),
